/*
Bruce Adams, CS 2318-251, Assignment 2 Part 2
a2p2.cpp
March 21, 2017
This program reconfigures the C++ code, removing do-whiles,
whiles, if and for controls with branches and goto's to simulate
pseudo-code for assembly, but it compiles as a C++ program.

The program prompts the user to enter integers
...
endW4:
 ...
 //            }
 //            while (reply != 'n' && reply != 'N');
 endDW1://     if (reply != 'n' && reply != 'N') goto begDW1;
