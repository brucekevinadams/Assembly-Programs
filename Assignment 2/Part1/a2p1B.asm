...
main:
		...
		# if $t2 is 0, then number
		# entered is 31 or less, if $t2 is 1 or greater
		# then number is 32 or more
		
		li $t3, 1			# Value to check against
		
		sge $t4, $t1, $t3 		# if $t2 >= 1, set $t4 to 1
		...
		move $a0, $t4			# move value from $t3 to $a0
		syscall
